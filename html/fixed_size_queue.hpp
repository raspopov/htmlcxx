...
//            std::random_access_iterator_tag
//        > base_t;
	typedef iterator<std::random_access_iterator_tag, T> base_t;
...
//        const &x) const
	bool equal(iterator<C, V> const &x) const
    {
